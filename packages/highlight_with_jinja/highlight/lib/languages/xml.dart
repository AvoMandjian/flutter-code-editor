...
final xml = Mode(
  // keywords: 'p i h1 h2 h3 h4 h5 h6 a img ul li div span',
  refs: {
    ...
    '~contains~0~contains~2': Mode(className: "meta-string", begin: "'", end: "'", illegal: "\\n", contains: [BACKSLASH_ESCAPE]),
    '~contains~0~contains~1': Mode(className: "meta-string", begin: "\"", end: "\"", illegal: "\\n", contains: [BACKSLASH_ESCAPE]),
  ...
  contains: [
    ...
    Mode(
      ...
      contains: [Mode(ref: '~contains~6~contains~0')],
      starts: Mode(end: "</script>", returnEnd: true, subLanguage: ["actionscript", "javascript", "handlebars", "xml"]),
    ),
    Mode(
      className: "tag",
      begin: "</?",
